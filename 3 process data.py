...
max_date = max_date_solis if max_date_solis < max_date_octopus else max_date_octopus
...
df4 = (
    ...
    .with_columns(value_kwh_electric_generation = pl.when(pl.col.value_kwh_electric_generation.is_null() & ~pl.col.value_kwh_electric_export.is_null()).then(pl.col.value_kwh_electric_export).otherwise(pl.col.value_kwh_electric_generation)) 
    .fill_nan(0)
    .fill_null(0)
    .with_columns(
    ...
    .with_columns(
        value_gbp_electric_import_avoided=pl.col.charge_per_kwh_electric_import*pl.col.value_kwh_electric_generation_consumed
    )
    .with_columns(
        value_gbp_electric_savings=pl.col.value_gbp_electric_import_avoided + pl.col.value_gbp_electric_export
    )
    .with_columns(
